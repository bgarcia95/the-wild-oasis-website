...
export default function Page() {
  return (
    <div className="grid grid-cols-5 gap-x-24 gap-y-32 text-lg items-center">
      ...
      {/* This technique works by setting a fixed aspect ratio for dynamic urls on images
          and then using object-cover to ensure the image fills the container without distortion.
      */}
